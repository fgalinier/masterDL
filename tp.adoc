:title: TP SysML
:doctype: article
:Author: Florian Galinier & Christelle Chaudet
:Email: {florian.galinier,christelle.chaudet}@irit.fr
...
:exigences: https://docs.google.com/spreadsheets/d/1E2airXijKuRWwcdm31c4NTADObAdzC6Qv8ZBh6hBfUo/edit?usp=sharing
...
:tpurl: https://fgalinier.github.io/masterDL/sujet.pdf
...
On souhaite dans ce projet réaliser la modélisation {sysml} du Landing Gear System.
...
Définition::
	Le *Landing Gear System* est une description du train d'atterrissage d'un avion.
