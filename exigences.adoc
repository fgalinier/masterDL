...
image::ingenierie-des-exigences.jpg[alt="Joke",link="http://www.inria.fr/centre/rennes/actualites/vers-un-cahier-des-charges-mieux-formule",width=100,scaledwidth=40]
...
[{incremental}]
Les ingénieurs systèmes ont depuis longtemps intégré le terme d'exigences comme traduction directe de _requirement_.
...
image::ProgrammerHumor.jpg[alt="Joke",link="https://plus.google.com/100035762233109552669/posts/a8Hafq2hZ74",width=40%,scaledwidth=40]
ifdef::slides[[detail]#{mycaption}#]
...
.Définition : image:sysml.jpeg[width=20] _Requirements_ (OMG SysML v1.5, p. 161)
[CAUTION]
====
...
[[corde]]
:mycaption: Un exemple de _Requirement_ en SysML (source <<SysML>>, p. 159)
ifndef::slides[.{mycaption}]
...
À partir du moment où on commence à définir des propriétés pour les exigences,
...
Dans le cadre de ce module nous ne retiendrons comme attribut d'un _requirement_
...
:mycaption: Exemples de relations entre exigences
ifndef::slides[.{mycaption}]
...
:mycaption: Relations liées aux _requirements_ dans TOPCASED
ifndef::slides[.{mycaption}]
...
:mycaption: Exemples de composition d'exigences (tiré de <<SysML>>)
ifndef::slides[.{mycaption}]
...
:mycaption: Exemple de lien entre use case et requirements
ifndef::slides[.{mycaption}]
...
Ce diagramme est celui que vous connaissez déjà en {uml}.
...
ifndef::slides[.{mycaption}]
image::matriceTraca.png[width=70%,link="http://infocenter.sybase.com/archive/index.jsp?topic=/com.sybase.stf.poweramc.docs_12.0.0/html/exgu/exgup38.htm"]
ifdef::slides[[detail]#{mycaption}#]
